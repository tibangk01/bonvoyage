...
<head>
    ...
    <title>Admin | Lomé - Cinkanssé </title>
</head>
                                               ...
                                               <div class="col-10">
                                                   <form action="">
                                                        <div class="form-group row justify-content-md-center">
                                                          <div class="col-sm-12 ">
                                                            <input type="text" class="form-control" id="" placeholder="Entrer Une Ville : Tsévié, Mango, ...">
                                                          </div>
                                                        </div>
                                                        <div class="form-group row justify-content-md-center">
                                                          <div class="col-sm-12">
                                                            <input type="text" class="form-control" id="" placeholder="Entrer Une Distance (Km) : 100, 215, ...">
                                                          </div>
                                                        </div>
